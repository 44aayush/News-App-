...
import 'package:news_app_bloc/blocs/newsbloc/news_bloc.dart';
import 'package:news_app_bloc/blocs/newsbloc/news_states.dart';
            ...
            child: BlocBuilder<NewsBloc, NewsStates>(
              builder: (BuildContext context, NewsStates state) {
                if (state is NewsLoadingState) {
                  ...
                  _articleList = state.articleList.cast<ArticleModel>();
